...
(define neo-parser
  (lambda (neo-code)
    (cond
      ...
      ;((asign x 8) -> (assign-exp x (num-exp 8))
      ((equal? (car neo-code) 'assign) (list 'assign-exp (cadr neo-code) (neo-parser (caddr neo-code))))
      ;(block (assign x 8) (print x)) -> (block-exp (assign-exp x (num-exp 8) (print-exp (var-exp a))
...
;((let-exp ((a (num-exp  1)) (b (num-exp 2)) (c (var-exp 3))) (parsed-neo-code))
